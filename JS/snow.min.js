...
function() {
    ...
    function m(t, n) {
        Object.keys(n).forEach(function(e) {
            var a = e;
            l && -1 < e.search("animation") && (a = l + e[0].toUpperCase() + e.substr(1)),
            t.style[a] = n[e]
        })
    }
    function c(e, a) {
    ...
    var a, t, i, r = function() {
        function s(e, a, t) {
            ...
            this.innerSize = n ? 0 : c(0, s.maxInnerSize),
            this.size = s.calcSize(this.innerSize, t);
            ...
            n || (r.zIndex = t.zIndex + 10 * this.size, r.opacity = f(this.size, t.minSize, t.maxSize, t.minOpacity, t.maxOpacity)),
            m(l, r),
            m(i, {
                animationName: "snowflake_x_" + this.innerSize,
                animationDelay: Math.random() + "s"
            }),
            l.classList.add("snowflake"),
            i.classList.add("snowflake__inner"),
            t.types && i.classList.add("snowflake__inner_type_" + c(0, t.types)),
            t.wind && i.classList.add("snowflake__inner_wind"),
            t.rotation && i.classList.add("snowflake__inner_rotation" + (.5 < Math.random() ? "": "_reverse")),
            l.appendChild(i),
            this._elem = l,
            e.appendChild(l)
        }
    ...
    i = 20,
    (t = "maxInnerSize") in (a = r) ? Object.defineProperty(a, t, {
        value: i,
        enumerable: !0,
        configurable: !0,
        writable: !0
    ...
    d = function() {
        function l(e) {
            ...
            this._imagesStyleNode = this._injectStyle(s.replace(/%7Bcolor%7D/g, encodeURIComponent(this.params.color))),
        ...
        },
        {
            ...
            value: function(l) {
                l = l || {};
                var i = {};
                return [["color", "#5ECDEF"], ["container", document.body], ["count", 50], ["speed", 1], ["stop", !1], ["rotation", !0], ["minOpacity", .6], ["maxOpacity", 1], ["minSize", 8], ["maxSize", 18], ["types", 6], ["width"], ["height"], ["wind", !0], ["zIndex", 9999]].forEach(function(e) {
                    var a = o(e, 2),
                    t = a[0],
                    n = a[1];
        ...
        },
        {
            key: "_injectStyle",
            value: function(e, a) {
                return a || (a = document.createElement("style"), document.body.appendChild(a)),
                a.styleSheet ? a.styleSheet.cssText = e: "textContent" in a ? a.textContent = e: a.innerHTML = e,
                a
            }
        },
        {
            key: "_removeStyle",
            value: function() {--l._count <= 0 && (l._count = 0, l._mainStyleNode && (l._mainStyleNode.parentNode.removeChild(l._mainStyleNode), delete l._mainStyleNode)),
                this._animationStyleNode && (this._animationStyleNode.parentNode.removeChild(this._animationStyleNode), delete this._animationStyleNode),
                this._imagesStyleNode && (this._imagesStyleNode.parentNode.removeChild(this._imagesStyleNode), delete this._imagesStyleNode)
            }
        },
        {
            key: "_height",
        ...
        },
        {
            ...
            value: function() {
                ...
                return window.innerHeight ? e = window.innerHeight: t && t.clientHeight ? e = t.clientHeight: a && (e = a.clientHeight),
                e
            }
        }]),
        l
